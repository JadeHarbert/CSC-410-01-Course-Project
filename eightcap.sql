...
COPY public.client (client_id, first_name, last_name, date_of_birth, datetime_of_entry, prescreen_date, dba_id, hmis, notes, email, county_id, preferred_contact_id, phone_number_id) FROM stdin;
2	John	Johns	2000-01-01	2023-04-13 00:00:00	\N	\N	\N	\N	\N	1	1	\N
3	Mark	Anthony	1000-06-16	2023-04-15 00:00:00	\N	\N	\N	\N	\N	2	\N	\N
4	Matthew	Kravitz	1996-01-20	2023-04-15 00:00:00	\N	\N	\N	\N	\N	3	\N	\N
5	Nick	Cramer	2000-01-01	2023-04-15 00:00:00	\N	\N	\N	\N	\N	1	\N	\N
\.
...
1	3	2023-04-15 16:53:17.120201	They're Not Real.
\.
...
1	Housing	housing issues	2	1	2023-04-13 00:00:00	2023-04-13 00:00:00	1	1	e
2	Not Real	I'm Not Real.	4	1	2023-04-15 16:21:50.215677	2023-04-15 16:21:50.215677	\N	1	\N
3	Not Real	I'm Also Not Real.	3	1	2023-04-15 16:27:44.765563	2023-04-15 16:27:44.765563	\N	2	\N
\.
...
SELECT pg_catalog.setval('public.followups_followup_id_seq', 1, true);
...
--
-- Name: client fk_client_county; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.client
    ADD CONSTRAINT fk_client_county FOREIGN KEY (county_id) REFERENCES public.county(county_id);


--
-- Name: client fk_client_preferred_contact; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.client
    ADD CONSTRAINT fk_client_preferred_contact FOREIGN KEY (preferred_contact_id) REFERENCES public.preferred_contact(preferred_contact_id);
...
--
-- Name: client phonefk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.client
    ADD CONSTRAINT phonefk FOREIGN KEY (phone_number_id) REFERENCES public.phone_number(phone_number_id);
